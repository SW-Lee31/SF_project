...
async def work_blue():
    ...
    await asyncio.sleep(1)
    Arm.Arm_serial_servo_write6(120, 106, 111, 173, 122, 145, 1000)
    await asyncio.sleep(2)
    Arm.Arm_serial_servo_write6(0, 106, 111, 173, 90, 145, 1000)
    await asyncio.sleep(2)
    Arm.Arm_serial_servo_write6(0, 53, 177, 180, 90, 145, 1000)
    await asyncio.sleep(2)
    Arm.Arm_serial_servo_write6(0, 53, 177, 180, 90, 80, 1000)
    await asyncio.sleep(2)
    Arm.Arm_serial_servo_write6(0, 40, 180, 170, 90, 80, 500)
    await asyncio.sleep(2)
